...
class PurchaseOrder(db.Model):
    ...
    vlr_icms_st = db.Column(db.Float, nullable=True)
    moeped = db.Column(db.String, nullable=True)
    for_uf = db.Column(db.String(2), nullable=True)
    tra_cod = db.Column(db.String, nullable=True)
    tra_descricao = db.Column(db.String, nullable=True)
    tra_uf = db.Column(db.String(2), nullable=True)
    red_cod = db.Column(db.String, nullable=True)
    red_descricao2 = db.Column(db.String, nullable=True)
    red_uf = db.Column(db.String(2), nullable=True)
    tp_frete_tra = db.Column(db.String, nullable=True)
    tp_vlr_frete_tra = db.Column(db.String, nullable=True)
    moetra = db.Column(db.String, nullable=True)
    vlr_frete_tra = db.Column(db.Float, nullable=True)
    tp_frete_red = db.Column(db.String, nullable=True)
    tp_vlr_frete_red = db.Column(db.String, nullable=True)
    moered = db.Column(db.String, nullable=True)
