    ...
    try {
      ...
      setTimeout(() => {
        if (quotationDataRef.current) {
          quotationDataRef.current.scrollIntoView({
            behavior: "smooth",
            block: "start",
          });
        }
            ...
            <Card className="section-card">
              <Box className="section-content">
                <Typography variant="subtitle1" sx={{ mb: 2 }}>
                  Data de Emissão:{" "}
                  {new Date(quotationData.dt_emissao).toLocaleDateString(
                    "pt-BR"
                  )}
                </Typography>
                    ...
                    <TableBody>
                      {quotationData.items.map((item, index) => (
                        ...
                        >
                          ...
                          <TableCell>
                            {item.last_purchase
                              ? formatCurrency(item.last_purchase.price)
                              : "—"}
                          </TableCell>
                          <TableCell>
                            {item.last_purchase
                  ...
                  <Table size="small" stickyHeader>
                    ...
                    <TableBody>
                      ...
                      {(() => {
                        ...
                        extractedData.extractedData.forEach(
                          (supplier, supplierIndex) => {
                            supplier.items.forEach((item) => {
                              const key =
                                item.matchedItemDescription || item.description;
                          ...
                          .map((item, index) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {item.supplier_prices.map(
                                  (supplierPrice, spIndex) => {
                                    const isBestPrice =
                                      supplierPrice &&
                                      supplierPrice.price === bestPrice &&
                                ...
                                <TableCell align="center" sx={{}}>
                                  {(() => {
                                    if (
                                      !bestPrice ||
                                      !item.last_purchase ||
                                      !item.last_purchase.price
                                    )
                                      return "—";

                                    const lastPrice = item.last_purchase.price;
                                    const variation =
                                      ((bestPrice - lastPrice) / lastPrice) *
                                      100;
                                    const color =
                                      variation < 0
                                        ? "success.main"
                                ...
                                <TableCell align="center" sx={{}}>
                                  {(() => {
                                    ...
                                    const bestPriceSupplierIndex =
                                      item.supplier_prices.findIndex(
                                        (sp) =>
                                          sp &&
                                          sp.price === bestPrice &&
                                          sp.price > 0
                                ...
                                <TableCell align="center" sx={{}}>
                                  {(() => {
                                    ...
                                    const matchingItem = supplier.items.find(
                                      (supplierItem) =>
                                        (supplierItem.matchedItemDescription ===
                                          item.description ||
